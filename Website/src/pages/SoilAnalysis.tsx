          ...
          <form onSubmit={handleSubmit} className="enhanced-tile bg-background p-6 rounded-lg">
            ...
            <div className="flex flex-col justify-center items-center gap-4 mt-8">
              <div className="flex flex-col md:flex-row gap-4 w-full max-w-md">
                ...
                >
                  <Database className="mr-2 h-5 w-5" /> Fetch Data
                </Button>
                <Button 
                  type="submit" 
        ...
        <TabsContent value="results" className="animate-fade-in">
          {Object.values(formData).some(value => value > 0) ? (
            ...
            <div className="text-center p-12 border border-[#c8c8c9] rounded-lg">
              ...
              <p className="max-w-md mx-auto mb-6">Either enter your soil parameters manually in the Input Form tab or use the "Fetch Data" button to generate sample data.</p>
              <Button 
